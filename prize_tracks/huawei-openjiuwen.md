...
| **Mapper** | Classical (numpy) | Pi | Fuses 5 sensor types into 2D occupancy grid with log-odds confidence | Frontend (WebSocket at 5 Hz) + Planner (via `get_obstacles`) |
